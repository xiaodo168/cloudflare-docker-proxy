...
> If you're looking for proxy for helm, maybe you can try [cloudflare-helm-proxy](https://github.com/xiaoxo168/cloudflare-helm-proxy).
...
2. use custom domain: support proxy multiple registries route by host
   ...
   ```javascript
   const routes = {
     "jx.hary.us.kg": "https://registry-1.docker.io",
     "quay.hary.us.kg": "https://quay.io",
     "gcr.hary.us.kg": "https://k8s.gcr.io",
